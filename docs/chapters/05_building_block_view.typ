...
#arc42help[
  ...
  *Form*
  ...
  #figure(
    image("../images/05_building_blocks-DE.png", width: 100%),
    caption: [Hierarchie in der Bausteinsicht],
  )
  ...
  *Ebene 3* zoomt in einige Bausteine der Ebene 2 hinein, usw.
  ...
  _Weiterführende Informationen:_ Siehe #link("https://docs.arc42.org/section-5/")[Bausteinsicht] in der online-Dokumentation (auf Englisch!).
]
...
#arc42help[
  ...
  #table(
    columns: (1fr, 2fr),
    table.header[*Name*][*Verantwortung*],
