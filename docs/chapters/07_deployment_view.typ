...
MongoDB wird bewusst nicht auf den Host gemappt, da nur das Backend darauf zugreifen darf.
...
`http://localhost:8080` und reißt die Umgebung danach ab. Damit testen E2E-Tests
